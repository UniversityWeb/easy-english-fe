...
import { ChakraProvider, Box, VStack, HStack, Button, Flex, Heading, Tab, TabList, Tabs } from "@chakra-ui/react";
  ...
  return (
    <ChakraProvider>
      <VStack h="100vh" bg="gray.50">
        {/* Header section */}
        <Flex bg="gray.800" color="white" px="8" py="4" alignItems="center" w="full">
          <Button
          ...
          <Tabs
            ...
            ml="auto"
            onChange={(index) => {
              const tabNames = ["Curriculum", "Drip", "Settings", "Pricing", "FAQ", "Notice"];
          ...
          <Button colorScheme="blue" variant="solid" onClick={() => navigate(`/course/view/${courseId}`)}>
            View
          </Button>
        </Flex>
