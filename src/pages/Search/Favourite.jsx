    ...
    useEffect(() => {
        const fetchCourses = async () => {
            try {
                ...
                const response = await courseService.getCourseOfFavourite(courseRequest);
                if (response) {
                    setCourses(response);
                }
            } catch (error) {
                                        ...
                                        >
                                            ...
                                            <Flex mt="4" alignItems="center" justify="space-between">
                                                <HStack spacing="1">
                                                    ...
                                                    <Text fontSize="sm">{course.level?.name || "No level"}</Text>
                                                </HStack>
                                                <HStack spacing="1">
                                                    <Icon as={IoBookOutline} boxSize={5} color="gray.600" />
                                                    <Text fontSize="sm">{course.countSection} Lectures</Text>
                                                </HStack>
                                                <HStack spacing="1">
